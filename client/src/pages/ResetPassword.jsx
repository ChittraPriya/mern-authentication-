...
const ResetPassword = () => {
  ...
  const [isOtpSubmited, setIsOtpSubmited] = useState(false);
    ...
    const handlePaste = (e) => {
      ...
      pasteArray.forEasch((char, index) =>{
  ...
  return (
    <div className='flex items-center justify-center min-h-screen bg-gradient-to-br gtom-blur-200 to purple-400'>
      ...
      <buttom className='w-full py-2.5 bg-gradient-to-r from-indigo-500 to-indogo-900 text-white rounded-full mt-3'>Submit</buttom>
      </form>
      }
      ...
      <form onSubmit={onSubmitOTP} className='bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm '>
        ...
        <div className='flex justify-between mb-8' onPaste={handlePaste}>
          {Array(6).fill(0).map((_, index) =>(
            ...
            className='w-12 h-12 bg-[#333A5C] text-white text-center tect-xl rounded-md'
